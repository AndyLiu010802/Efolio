...
const checkFriend = (input) => {
  const lowerCaseReason = formData.value.reason.toLowerCase();
  if (lowerCaseReason.includes('friend')) {
    if (input) errors.value.reason = 'Great to have a friend!';
  } else {
